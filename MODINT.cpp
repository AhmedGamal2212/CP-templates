template<int mod = 1000000007> struct ModInt {
    ...
    ModInt& operator/=(const int rhs) {
        return *this *= ModInt(rhs).inverse();
    }
    ...
    ModInt operator+(const int rhs) const {
        ModInt res(*this);
        return res += rhs;
    }
    ...
    friend ModInt operator^(ModInt rhs, ll n) {
        return rhs.power(n);
    }

    friend ModInt operator^(ModInt rhs, ModInt n) {
        return rhs.power(n);
    }
